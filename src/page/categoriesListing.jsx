...
import { setDataCategories } from '../redux/productSlide';
...
export default function CategoriesListing() {
  ...
  const fetchCategories = async () => {
    ...
    dispatch(setDataCategories(resData));
  };
  ...
  const handleDelete = async (id) => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_SERVER_DOMIN}/category/${id}`,
        {
          method: 'DELETE',
          headers: {
  ...
  const handleAddNew = () => navigate('/category');
